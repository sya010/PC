<div class="space-y-24 pb-24">
    ...
    <section class="relative min-h-[700px] flex items-center justify-center overflow-hidden">
        ...
        <div class="absolute inset-0 z-0">
            ...
            <div class="absolute -top-40 -start-40 w-[600px] h-[600px] bg-indigo-600/30 rounded-full blur-[100px] animate-pulse"></div>
        </div>
        ...
        <div class="container mx-auto px-4 relative z-10">
            <div class="max-w-3xl">
                ...
                <div class="flex flex-col sm:flex-row gap-4 animate-slide-up" style="animation-delay: 200ms;">
                    <a href="{{ route('shop') }}" class="w-full sm:w-auto text-center px-8 py-4 bg-indigo-600 hover:bg-indigo-500 text-white rounded-2xl font-bold transition-all transform hover:-translate-y-1 shadow-lg shadow-indigo-600/30 ring-4 ring-indigo-600/20">
    ...
    <section class="container mx-auto px-4">
        <div class="flex justify-between items-end mb-12">
            <div>
                <span class="text-indigo-600 font-bold tracking-wider uppercase text-sm mb-2 block">{{ __('messages.home.premium_selection') }}</span>
    ...
    <section class="container mx-auto px-4">
        <div class="flex justify-between items-end mb-12">
            <div>
                <span class="text-indigo-600 font-bold tracking-wider uppercase text-sm mb-2 block">{{ __('messages.home.level_up_setup') }}</span>
                <h2 class="text-4xl font-bold text-slate-900 mb-3 tracking-tight">{{ __('messages.home.gaming_gear') }}</h2>
                <div class="w-20 h-1.5 bg-indigo-600 rounded-full"></div>
            </div>
    ...
    <section class="container mx-auto px-4">
        <div class="grid md:grid-cols-3 gap-8">
            <div class="bg-white rounded-3xl p-8 text-center hover:-translate-y-2 transition-transform duration-300 border border-slate-100 shadow-sm hover:shadow-xl group">
                ...
                <h3 class="text-xl font-bold text-slate-900 mb-3">{{ __('messages.home.features_compatibility_title') }}</h3>
                <p class="text-slate-500 leading-relaxed">{{ __('messages.home.features_compatibility_desc') }}</p>
            </div>
            ...
            <div class="bg-white rounded-3xl p-8 text-center hover:-translate-y-2 transition-transform duration-300 border border-slate-100 shadow-sm hover:shadow-xl group">
                ...
                <h3 class="text-xl font-bold text-slate-900 mb-3">{{ __('messages.home.features_shipping_title') }}</h3>
                <p class="text-slate-500 leading-relaxed">{{ __('messages.home.features_shipping_desc') }}</p>
            </div>
            ...
            <div class="bg-white rounded-3xl p-8 text-center hover:-translate-y-2 transition-transform duration-300 border border-slate-100 shadow-sm hover:shadow-xl group">
                ...
                <h3 class="text-xl font-bold text-slate-900 mb-3">{{ __('messages.home.features_support_title') }}</h3>
                <p class="text-slate-500 leading-relaxed">{{ __('messages.home.features_support_desc') }}</p>
            </div>
        </div>
    </section>
</div>
