<div class="max-w-2xl mx-auto">
    ...
    <div class="flex items-center justify-between mb-8">
        <div>
            ...
            <p class="text-gray-500 mt-1">Update user account details and permissions.</p>
        </div>
    ...
    <form wire:submit="save" class="space-y-6">
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 space-y-6">
            <!-- Name -->
            <div class="group">
                <label class="block text-sm font-semibold text-gray-700 mb-1.5 group-focus-within:text-indigo-600 transition-colors">Full Name</label>
            ...
            <!-- Email -->
            <div class="group">
                <label class="block text-sm font-semibold text-gray-700 mb-1.5 group-focus-within:text-indigo-600 transition-colors">Email Address</label>
            ...
            <div class="flex items-center justify-between p-2">
                <div>
                    <h4 class="text-sm font-bold text-gray-900">Administrator Access</h4>
                    <p class="text-xs text-gray-500 mt-0.5">Allow this user to access the admin panel and manage content.</p>
                </div>
