<div>
    ...
    <div class="bg-white p-2 rounded-2xl border border-gray-100 shadow-sm mb-8 flex flex-col md:flex-row gap-2 transform transition-all hover:shadow-md">
        ...
        <div class="md:w-56 border-l border-gray-100 md:pl-2">
                        ...
                        <tr class="hover:bg-gray-50 transition-colors group">
                            ...
                            <td class="px-6 py-4 text-right">
                                <div class="relative inline-block text-left" x-data="{ open: false }">
                                    ...
                                    <div x-show="open" class="origin-top-right absolute right-0 mt-2 w-48 rounded-xl shadow-lg bg-white ring-1 ring-black ring-opacity-5 focus:outline-none z-10 overflow-hidden" style="display: none;" x-transition:enter="transition ease-out duration-100" x-transition:enter-start="transform opacity-0 scale-95" x-transition:enter-end="transform opacity-100 scale-100" x-transition:leave="transition ease-in duration-75" x-transition:leave-start="transform opacity-100 scale-100" x-transition:leave-end="transform opacity-0 scale-95">
                                      <div class="py-1">
