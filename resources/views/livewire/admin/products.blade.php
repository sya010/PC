<div>
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
        <div>
            ...
            <p class="text-gray-500 mt-1">Manage your catalog, inventory, and specifications.</p>
        </div>
    ...
    <div class="mb-8">
        <div class="relative max-w-md">
            <input 
                ...
                maxlength="100"
                class="w-full pl-12 pr-4 py-3.5 rounded-2xl border border-gray-200 bg-white/50 text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 focus:bg-white transition-all shadow-sm hover:border-indigo-300"
            >
        ...
        @foreach($products as $product)
            <div class="group bg-white rounded-2xl p-4 border border-gray-100 shadow-sm hover:shadow-xl hover:border-indigo-100 transition-all duration-300 relative flex flex-col">
                ...
                <div class="absolute inset-x-4 bottom-4 pt-4 bg-white/95 backdrop-blur-sm opacity-0 group-hover:opacity-100 transition-all duration-200 flex items-center justify-between gap-2 translate-y-2 group-hover:translate-y-0 shadow-[0_-10px_20px_rgba(255,255,255,0.8)] border-t border-gray-50 rounded-b-2xl">
                    ...
                    <button wire:click="delete({{ $product->id }})" wire:confirm="Are you sure?" class="p-2.5 text-rose-500 bg-rose-50 rounded-lg hover:bg-rose-100 transition-colors">
