        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="max-w-2xl mx-auto mb-12">
                <div class="relative">
                    ...
                    >
                    <svg class="absolute start-4 top-1/2 -translate-y-1/2 w-6 h-6 text-[var(--color-text-muted)]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div class="grid md:grid-cols-3 gap-6 mb-16">
                <div class="neu-card p-6 text-center hover:scale-105 transition-transform cursor-pointer">
                    ...
                    <p class="text-sm text-[var(--color-text-muted)]">{{ __('messages.support_page.live_chat_desc') }}</p>
                </div>
                ...
                <div class="neu-card p-6 text-center hover:scale-105 transition-transform cursor-pointer">
                    ...
                    <p class="text-sm text-[var(--color-text-muted)]">{{ __('messages.support_page.email_support_desc') }}</p>
                </div>
                ...
                <div class="neu-card p-6 text-center hover:scale-105 transition-transform cursor-pointer">
                    ...
                    <p class="text-sm text-[var(--color-text-muted)]">{{ __('messages.support_page.phone_support_desc') }}</p>
                </div>
            </div>
