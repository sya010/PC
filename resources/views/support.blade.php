    ...
    <section class="py-12 lg:py-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-2 gap-6 mb-16 max-w-2xl mx-auto">
                <a href="mailto:siakoahmad55@gmail.com" class="neu-card p-6 text-center hover:scale-105 transition-transform cursor-pointer block">
                ...
                <a href="tel:07507567564" class="neu-card p-6 text-center hover:scale-105 transition-transform cursor-pointer block">
