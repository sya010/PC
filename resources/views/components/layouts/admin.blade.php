        ...
        <aside class="w-64 bg-dark-900 text-dark-100 flex-shrink-0 hidden md:flex flex-col border-r border-dark-800">
            <div class="p-4 border-b border-dark-800 flex items-center justify-between">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <a href="{{ route('home') }}" class="text-dark-400 hover:text-white" title="{{ __('messages.admin.go_to_site') }}">
            ...
            <nav class="flex-1 overflow-y-auto py-4 px-2 space-y-1">
                <a href="{{ route('admin.dashboard') }}" 
                   class="flex items-center gap-3 px-3 py-2 rounded-md transition-colors {{ request()->routeIs('admin.dashboard') ? 'bg-brand-base text-white' : 'text-dark-400 hover:bg-dark-800 hover:text-white' }}">
                ...
                <a href="{{ route('admin.products') }}" 
                   class="flex items-center gap-3 px-3 py-2 rounded-md transition-colors {{ request()->routeIs('admin.products') ? 'bg-brand-base text-white' : 'text-dark-400 hover:bg-dark-800 hover:text-white' }}">
                ...
                <a href="{{ route('admin.orders') }}" 
                   class="flex items-center gap-3 px-3 py-2 rounded-md transition-colors {{ request()->routeIs('admin.orders') ? 'bg-brand-base text-white' : 'text-dark-400 hover:bg-dark-800 hover:text-white' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16"y1="13"x2="8"y2="13"/><line x1="16"y1="17"x2="8"y2="17"/><polyline points="10 9 9 9 8 9"/></svg>
                    {{ __('messages.admin.sidebar.orders') }}
                </a>

                <a href="{{ route('admin.users') }}" 
                   class="flex items-center gap-3 px-3 py-2 rounded-md transition-colors {{ request()->routeIs('admin.users') ? 'bg-brand-base text-white' : 'text-dark-400 hover:bg-dark-800 hover:text-white' }}">
                ...
                <a href="{{ route('profile') }}" 
                   class="flex items-center gap-3 px-3 py-2 rounded-md transition-colors text-dark-400 hover:bg-dark-800 hover:text-white">
