    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <aside class="w-64 bg-gray-900 text-white flex-shrink-0 hidden md:flex flex-col">
            <div class="p-4 border-b border-gray-800 flex items-center justify-between">
                ...
                <a href="{{ route('home') }}" class="text-gray-400 hover:text-white" title="Go to Site">
            ...
            <nav class="flex-1 overflow-y-auto py-4 px-2 space-y-1">
                ...
                <div class="pt-4 pb-2 px-3 text-xs font-semibold text-gray-500 uppercase tracking-wider">Management</div>
                ...
                <div class="pt-4 pb-2 px-3 text-xs font-semibold text-gray-500 uppercase tracking-wider">Personal</div>
